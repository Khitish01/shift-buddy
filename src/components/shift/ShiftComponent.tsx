    ...
    return (
        ...
        <div className="bg-white">
            ...
            <div className="flex justify-between items-center mb-3">
                <h1 className="font-semibold text-xl md:text-2xl">Shift Management </h1>
                <div className="flex items-center gap-3">
                    ...
                    <button className="bg-primary w-[75%] text-white px-4 py-2 rounded-lg flex items-center space-x-2 hover:bg-purple-900"
                        ...
                        onClick={() => setShowCarerModal(true)}
                    >
                        <Plus size={16} />
                        <span>Add Carer</span>
                    </button>
            ...
            <div className="flex items-center gap-6 mb-6 border-b border-[#D4D4D4] ">
                {shiftTabs.map((tab, i) => (
                    <button
                        key={i}
                        onClick={() => setActiveTab(i)}
                        className={`pb-2 mt-3 text-sm font-medium border-b-3 ${activeTab === i
                ...
                <button
                    className="flex items-center justify-center w-7 h-7 rounded-full bg-[#F2C7AC] text-[22px] text-primary font-bold leading-none"
